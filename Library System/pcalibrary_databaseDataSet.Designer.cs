...
namespace Library_System {
    ...
    public partial class pcalibrary_databaseDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/pcalibrary_databaseDataSet.xsd";
        ...
        public partial class booksDataTable : global::System.Data.TypedTableBase<booksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public booksRow AddbooksRow(long ISBN, string BookName, string Author, string Section, string Comment) {
...
namespace Library_System.pcalibrary_databaseDataSetTableAdapters {
    ...
    public partial class booksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `books` WHERE ((`ISBN` = @p1) AND (`BookName` = @p2) AND (`Author` = " +
                "@p3) AND (`Section` = @p4) AND (`Comment` = @p5))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `books` (`ISBN`, `BookName`, `Author`, `Section`, `Comment`) VALUES (" +
                "@p1, @p2, @p3, @p4, @p5)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `books` SET `ISBN` = @p1, `BookName` = @p2, `Author` = @p3, `Section` = @p" +
                "4, `Comment` = @p5 WHERE ((`ISBN` = @p6) AND (`BookName` = @p7) AND (`Author` = " +
                "@p8) AND (`Section` = @p9) AND (`Comment` = @p10))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Library_System.Properties.Settings.Default.pcalibrary_databaseBooks;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `ISBN`, `BookName`, `Author`, `Section`, `Comment` FROM `books`";
        ...
        public virtual int Delete(long p1, string p2, string p3, string p4, string p5) {
        ...
        public virtual int Insert(long p1, string p2, string p3, string p4, string p5) {
        ...
        public virtual int Update(long p1, string p2, string p3, string p4, string p5, long p6, string p7, string p8, string p9, string p10) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string p2, string p3, string p4, string p5, long p6, string p7, string p8, string p9, string p10) {
